...
# CHANGE THIS LINE
python test.py --dataroot /content/drive/MyDrive/Part_II_Project/testB_8b --checkpoints_dir /content/drive/MyDrive/Part_II_Project/checkpoints/hsi_to_rgb_cyclegan_rep2 --dataset_mode hsi_unaligned --model cycle_gan -–num_test 846 --name hsi_to_rgb_cyclegan_rep2quant8 --epoch str(ep) --num_threads 0 --preprocess resize_and_crop --load_size 286 --batch_size 1 --crop_size 256 --no_dropout
# --CUT_mode CUT 
# --model cycle_gan
