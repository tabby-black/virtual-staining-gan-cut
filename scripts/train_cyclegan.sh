...
python train.py --dataroot ./datasets/histology_full --name hsi_to_rgb_CUTrep2 --CUT_mode CUT --dataset_mode hsi_unaligned --patch_mode random_crop --gpu_ids 0 --use_wandb --wandb_project_name hyperspectral_image_reconstruction --nce_idt False --nce_layers 4,8,12,16 --lr_policy linear --n_epochs 100 --n_epochs_decay 100 --pool_size 50 --no_dropout --print_freq 100 --save_epoch_freq 1 --display_id -1 --num_threads 2 --no_html --batch_size 1
