...
python train.py --dataroot /content/drive/MyDrive/Part_II_Project --checkpoints_dir /content/drive/MyDrive/Part_II_Project/checkpoints --dataset_mode hsi_unaligned --patch_mode random_crop --name hsi_to_rgb_CUTrep2 --CUT_mode CUT --use_wandb --wandb_project_name hyperspectral_image_reconstruction --nce_idt False --nce_layers 4,8,12,16 --lr_policy linear --n_epochs 100 --n_epochs_decay 100 --pool_size 50 --no_dropout --print_freq 100 --save_epoch_freq 1 --display_id -1 --num_threads 0 --no_html --batch_size 1
